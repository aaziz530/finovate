...
public class AuthController {
    ...
    private void handleRegister() {
        ...
        try {
            ...
            user.setCinNumber(cinNumber);
            user.setRole(User.Role.USER);
            user.setSolde(500.0f); // Default balance
            user.setPoints(0);
            
            // Generate card number
            long cardNumber = 4000000000000000L + (long)(Math.random() * 999999999999999L);
            user.setNumeroCarte(cardNumber);
    ...
    private void handleResetPassword() {
        ...
        try {
            ...
            User user = userService.getUserByUsername(currentResetEmail);
            if (user == null) {
            ...
            boolean updated = userService.updateUser(user, user.getId(), User.Role.ADMIN);
            ...
            if (updated) {
                ...
                showResetPassError("Failed to update password");
            }
