...
public class PostService {
     ...
     */
    public boolean updatePost(Post post, int requestingUserId, User.Role requestingUserRole,
     ...
     */
    public boolean deletePost(int postId, int requestingUserId, User.Role requestingUserRole) throws SQLException {
        // Vérifier les droits
        if (requestingUserRole == User.Role.USER) {
