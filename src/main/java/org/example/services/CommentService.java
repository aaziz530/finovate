...
public class CommentService {
     ...
     */
    public boolean updateComment(Comment comment, int requestingUserId, User.Role requestingUserRole,
        ...
        // Vérifier les droits
        if (requestingUserRole == User.Role.USER) {
     ...
     */
    public boolean deleteComment(int commentId, int requestingUserId, User.Role requestingUserRole) throws SQLException {
        // Vérifier les droits
        if (requestingUserRole == User.Role.USER) {
        ...
        } else if (requestingUserRole == User.Role.MODERATOR) {
