...
import org.esprit.finovate.services.RecommendationEngine;
import org.esprit.finovate.services.RecommendationEngine.RecommendedForum;
...
public class RecommendationsController {
    ...
    public void loadRecommendations(int userId) {
        ...
        // Vérifier que l'utilisateur existe avant de calculer
        if (!userExists(userId)) {
            emptyLabel.setText("Utilisateur introuvable");
