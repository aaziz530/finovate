...
public class EditProjectController implements Initializable {
    ...
    private Runnable embeddedReturnCallback; // For navigation within UserDashboard contentArea
    ...
    public void setEmbeddedReturnCallback(Runnable r) { this.embeddedReturnCallback = r; }
    ...
    private void handleCancel() throws IOException {
        // Priority: embedded callback > admin callback > my projects > dashboard
        if (embeddedReturnCallback != null) {
            embeddedReturnCallback.run();
            return;
        }
