...
public class AddProjectController implements Initializable {
    ...
    private Runnable onProjectCreatedCallback; // For embedded navigation in UserDashboard
    ...
    public void setOnProjectCreatedCallback(Runnable callback) {
    ...
    private void navigateBack() {
        // If embedded in UserDashboard, use callback to navigate within contentArea
        if (onProjectCreatedCallback != null) {
            onProjectCreatedCallback.run();
            return;
        }
        // Fallback: standalone mode - create new scene with full dashboard
        try {
